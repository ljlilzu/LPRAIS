...
import random
import datetime
from lprais import lprais_function
...
def LP(graph_file, out_file, sim_method, t, p, alpha,rele, phi, sigma):
    ...
    for it in range(t):
        ...
        sim_dict = lprais_function(training_graph, sim_method, alpha,graph_file,rele, phi, sigma)   
